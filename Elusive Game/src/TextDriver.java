...
public class TextDriver{
	...
	public static void main(String[] args){
		...
		while (!endGame){
			...
			else if (output.equalsIgnoreCase("S"))
			{
				...
				"Check stats\r\n" +
				"Explore\r\n" +
				"Talk to [NPC Name] - (Blacksmith, shop keeper, bartender, innkeeper, dealer)\r\n" +
				"\r\n" +
				"Items Commands:\r\n" +
				"Examine [Item Name] - (Potion, magic key, etc.)\r\n" +
				"Pickup [Item Name]\r\n" +
				//"Buy [Item Name]\r\n" +
				//"Sell [Item Name]\r\n" +
				"Drop [Item Name]\r\n" +
		...
		if(player.checkScroll()) {
			System.out.println("\r\n"
					+ "A glow resonates from the scroll and appears to transfer to your father. He opens his eyes. Unable to speak due to his exhaustion, he hands you a treasure map."
					+ "\r\nYou think back to when he was first taken, but it all makes sense now. Your father held the secret to some sort of treasure the dragon wanted. When\r\n"
					+ "the dragon figured he couldn’t extract the treasure, he killed your father. Now, you could both set onto the adventure to find it.\r\n"
					+ "\r\n"
					+ "The end.");
		}
		else {
	...
	public static void createGame() {
		...
		System.out.println("\nOkay, " + userName);
		System.out.println("\nAfter arriving to the pond, you and dad got your fishing supplies ready. “Alright, " + userName + ", hook the bait onto the rod.”"
				+ "\n(Type in --hook bait-- to hook it)");
		String userInput = input.nextLine();
		System.out.println("Good Job! Now swing it into the water, as hard as you can."
				+ "\n(Type in --swing bait-- to swing it)");
		userInput = input.nextLine();
		System.out.println("“Now we wait.”");
		System.out.println("You feel your fishing rod being pulled." + "\n“Reel him in now!” "
				+ "\n(Type in --reel-- to reel the fish)");
		userInput = input.nextLine();
		System.out.println("\n“There he goes, that’s a big one!”" +
							"\nYou pull the fish in and relieve it from its hook. It thrashes about violently."
							+ "\nSuddenly, you hear a vicious roar from the distance as the earth below you shakes. "
							+ "\nA giant red creature swoops down from the sky and takes a hold of your father, knocking you out in the process. " + 
							"\nYou wake up in your home, confused. Your father is nowhere to be found. Many questions floated through your head, but you have the answer to none."
